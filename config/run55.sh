...
for dataset in 'gowalla' 'yelp' 'amazoni'
do
    ...
    do
        ...
        do
            ...
            do
                ...
                {
                    # 要执行的命令
                    nohup python main_more2.py -m 0 --lambda_w ${lambda} -lr ${lr} --data ${dataset} \
                    --sampler ${sampler} -s $n -e ${epoch} -b ${batch} --fix_seed  --log_path ${logs} \
